  ...
  return (
    ...
    >
      ...
      <video
        ...
        playsInline
        preload="auto"
        poster="/poster11.png" // Use a poster image to display before the video loads
        className="absolute inset-0 w-full h-full object-cover z-0" // Ensures the video covers the entire background
      >
