  ...
  return (
    <div>
      ...
      <div className="bg-black flex items-center justify-center min-h-screen p-10">
        <div className="flex flex-col gap-10 md:flex-row items-stretch justify-center mt-12 w-full max-w-6xl mx-auto">
          <div className="bg-[#222121] p-8 rounded-lg w-full md:w-1/2 text-white mb-8 md:mb-0 flex flex-col justify-between">
            <h1 className="md:text-xl text-md font-bold mb-6 text-center">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                className="w-full mb-4 p-3 rounded-xl bg-gray-700 text-white outline-none"
                placeholder="Navn"
                required
              />
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full mb-4 p-3 rounded-2xl bg-gray-700 text-white outline-none"
                placeholder="Epost"
                required
              />
              ...
              <button
                type="submit"
                className="w-full p-3 rounded-2xl text-white font-bold hover:bg-pink-800 transition duration-300"
                disabled={loading}
                style={{
                  background:
          ...
          <div
            className="p-8 rounded-xl w-full md:w-1/3 shadow-lg text-white flex flex-col items-center justify-between"
            style={{
          ...
          >
            ...
            <a href="mailto:kontakt@sidesone.no">
              <button className="bg-white text-green-900 font-bold py-3 px-10 rounded-lg hover:bg-gray-100 transition duration-300">
                Besøk oss
              </button>
            </a>
          </div>
