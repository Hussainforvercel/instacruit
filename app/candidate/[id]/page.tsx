...
//   {
//     console.log("Screenings in render:", screenings);
//   }
//   {
//   }
...
export default function CandidateProfile() {
  ...
  // const moveLeadToSelectedColumn = () => {
  //   if (selectedColumn && data && data._id) {
  //     const updatedColumns = { ...columns };
  //     const candidate = columns[selectedColumn].items.find(
  //       (item) => item.id === data._id
  //     );

  //     // Ensure that the candidate exists and is removed from its previous column
  //     if (candidate) {
  //       Object.keys(updatedColumns).forEach((columnId) => {
  //         updatedColumns[columnId].items = updatedColumns[
  //           columnId
  //         ].items.filter((item) => item.id !== data._id);
  //       });

  //       // Add the candidate to the selected column
